...
def self_test():
    ...
    # T4: 2-transitive: # of T sending (u1,u2) -> (v1,v2) equals q^2 - q = 6
    u1, u2 = (0, 0), (1, 0)
    v1, v2 = (0, 1), (2, 2)
    count = 0
    for L in gl:
    ...
    # T5: cross-field verification with F_2 (should give |AGL(2,F_2)|=24)
    q2 = 2
    agl_f2 = q2 ** 2 * (q2 ** 2 - 1) * (q2 ** 2 - q2)
    results.append(("T5_F2_order", agl_f2 == 24, f"|AGL(2,F_2)| = {agl_f2} expected 24"))

    # T6: F_{4096} target scale (formula only, not enumerated)
    q_big = 4096
