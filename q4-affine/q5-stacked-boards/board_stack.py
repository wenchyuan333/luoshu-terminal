...
Nested location: q4-affine/q5-stacked-boards/board_stack.py (2026-08-28 v2)
Author: 江坤晉 (wenchyuan333) × Miya
Session: 2026-08-28T05:10+08:00 → layered restructure 14:29+08:00
Branch: layered/q4-nested-stack
"""
...
_HAS_Q4 = False
try:
    _here = os.path.dirname(os.path.abspath(__file__))       # q4-affine/q5-stacked-boards/
    _q4_dir = os.path.dirname(_here)                          # q4-affine/
    _repo_root = os.path.dirname(_q4_dir)                     # repo root
    sys.path.insert(0, _repo_root)
    sys.path.insert(0, _q4_dir)
...
def main():
    print("=" * 60)
    print("q5-stacked-boards: board_stack self-test (nested under q4-affine)")
